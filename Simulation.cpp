...
//    UpdateEnvArray(&Environment, &oldEnvironment, FieldAgar, oldFieldAgar, FieldWall, oldFieldWall, DensityShiftP, Density1ShiftP, Density2ShiftP, WallDensityShiftP, WallDensity1ShiftP, WallDensity2ShiftP, minx, maxx, miny, maxy, maxz, Height, insideColonyDen);
    UpdateFlag = false;
    printf("Update initial Env. \n");
...
//            MyAssert(Nconv<maxIter,"Environment has not converged");
        ...
        // Move, growth cells, and update toggle states.
...
//            printf("Update Toggle. \n");
//            runSim(next_time, &new_cells[cellID]);
//            printf("Finish update Toggle. \n");
//            runSim(next_time, &new_cells[cellID]);
...
#pragma omp parallel for num_threads(omp_get_num_threads())
        for (cellID=0;cellID<N_cells;cellID++){
            runSim(next_time, &new_cells[cellID]);  // simulating toggle states.
        }
