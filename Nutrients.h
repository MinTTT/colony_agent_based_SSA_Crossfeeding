...
// localEnv include 4 properties, carbon, oxygen, waste and growthRate
struct LocalEnv
{
...
//    LocalEnv(double _carbon, double _growthrate): Carbon(_carbon), GrowthRate(_growthrate) {}
    ...
    LocalEnv(double _carbon, double _growthrate){
        Carbon = _carbon;
    ...
    LocalEnv(double _carbon, double _oxygen, double _waste, double _growthrate) {
       Carbon = _carbon;
       Oxygen = _oxygen;
       Waste = _waste;
       GrowthRate = _growthrate;
